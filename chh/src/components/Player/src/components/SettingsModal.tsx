...
const SettingsModal: FC<SettingsProps> = ({
  ...
  return (
    <div
      ...
      className={`chikiimass-backdrop ${settingsActive ? "chikiimass-show" : ""}`}
    >
      <div onClick={e => e.stopPropagation()} className="chikiimass-modal">
        ...
        <div className="chikiimass-modal-btn-container">
          <button
            style={{ padding: 5 }}
            onClick={() => setSettingsActive(false)}
          >
