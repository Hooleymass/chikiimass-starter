...
const Player: React.FC<PlayerProps> = ({ src, thumbnail, autoPlay = true }) => {
        ...
        return (
          ...
          >
            ...
            <div className={`vp-controls`}>
              ...
              />
              <div className={`vp-controls__header${!displayControls ? ' hid' : ''}`}>
              ...
              <div className={`vp-controls__body${!displayControls ? ' hide' : ''}`}>
                <div>
                  <Volume
                    volume={volumeState}
